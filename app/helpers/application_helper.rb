module ApplicationHelper
  ...
  # returns the new record created in notifcations table
  ...
  # Receives the notifcation object as a parameter along wiht a type
  # and returns a User record, Post record or Comment record
